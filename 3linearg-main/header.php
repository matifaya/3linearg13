<header>
		<nav class="navbar navbar-expand-lg bg-body-tertiary">
			<div class="container-fluid">
				<a class="navbar-brand" href="pagina.php"><img src="./img/logofinal.png" alt="" class="center"></a>
				...
				<div class="collapse navbar-collapse px-5 " id="navbarScroll">
				  <ul class="navbar-nav mx-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
					<li class="nav-item">
					  <a class="nav-link active mx-3" aria-current="page" href="pagina.php">Inicio</a>
					</li>
					<li class="nav-item">
					  <a class="nav-link mx-3" href="zapaindex.php">Calzado</a>
					</li>
					<li class="nav-item dropdown">
					  ...
					  <ul class="dropdown-menu">
						<li><a class="dropdown-item mx-3" href="zapaindex.php" >Calzado</a></li>
						<li><a class="dropdown-item mx-3" href="indumentaria.php">Indumentaria</a></li>
					
					  </ul>
					</li>
					<li class="nav-item">
					  <a class="nav-link mx-3" href="https://www.gmail.com/mail/help/intl/es/about.html?iframe" target="_blank" >Contacto</a>
					</li>
				  </ul>
				  <form class="d-flex" role="search">
					...
					<label class="popup">
					  ...
					  <nav class="popup-window">
						<legend><?php if($gmail_conectado != '') { echo $gmail_conectado; }  ?></legend>
						<ul>
						  
						  
						  <?php if($gmail_conectado == null) { ?>
						  <li>
							<a href="login.php">
							<button type="button">  
